...
class Janela3(QWidget):
    def __init__(self):
        ...
        self.setGeometry(10,100,500,400)
        # criar as labels para nome de usuário, email, senha e nível de acesso
        ...
        self.label_nivel_acesso = QLabel("Nível de Acesso:")
        ...
        self.edit_nome_usuario.setStyleSheet("QLineEdit{background-color:#999; color:#fff; padding:10px; border-radius:10px}")
        ...
        self.edit_senha.setStyleSheet("QLineEdit{background-color:#999; color:#fff; padding:10px; border-radius:10px}")

        self.edit_senha.setEchoMode(QLineEdit.EchoMode.Password)

        self.edit_nivel_acesso = QLineEdit()
        self.edit_nivel_acesso.setStyleSheet("QLineEdit{background-color:#999; color:#fff; padding:10px; border-radius:10px}")
